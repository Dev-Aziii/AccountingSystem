...
namespace AccountingSystem.API.Services.Interfaces
{
    public interface IAuthService
    {
        ...
        Task<User> InviteTenantUserAsync(InviteTenantUserDTO dto);
        Task ResendInviteAsync(int invitedUserId, int tenantId);
        ...
        Task<ConfirmEmailResultDTO> ConfirmEmailAsync(ConfirmEmailDTO dto);
