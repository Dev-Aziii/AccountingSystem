...
namespace AccountingSystem.API.Data
{
    public class AccountingDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DocumentSequence>().HasQueryFilter(e => !e.IsDeleted && e.CompanyId == _tenantService.GetCurrentTenant());
            ...
            modelBuilder.Entity<DocumentSequence>().Property(p => p.DocumentType).HasConversion<string>();
            ...
            modelBuilder.Entity<DocumentSequence>().HasIndex(s => new { s.CompanyId, s.DocumentType }).IsUnique();
